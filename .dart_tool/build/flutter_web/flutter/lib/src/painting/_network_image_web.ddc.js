define(['dart_sdk', 'packages/flutter/src/foundation/_bitfield_web', 'packages/flutter/src/gestures/arena', 'packages/flutter/gestures', 'packages/vector_math/vector_math_64'], function(dart_sdk, packages__flutter__src__foundation___bitfield_web, packages__flutter__src__gestures__arena, packages__flutter__gestures, packages__vector_math__vector_math_64) {
  ...
  dart.defineLazy(CT, {
    ...
    get C120() {
      return C120 = dart.constList([C117 || CT.C117, C118 || CT.C118, C119 || CT.C119], flutter_logo.FlutterLogoStyle);
    },
    get C121() {
    ...
    get C147() {
      return C147 = dart.constList([0.7071, -0.7071, 0, 0, 0.7071, 0.7071, 0, 0, 0, 0, 1, 0, -77.697, 98.057, 0, 1], core.double);
    },
    get C148() {
    ...
    get C154() {
      return C154 = dart.constList(["null"], core.String);
    },
    get C155() {
      return C155 = dart.fn(image_resolution.AssetImage._manifestParser, StringToFutureOfMapOfString$ListOfString());
    }
  });
  ...
  const platform$ = dart.privateName(image_provider, "ImageConfiguration.platform");
  let C38;
  ...
  image_provider.FileImage = class FileImage extends image_provider.ImageProvider {
    ...
    _equals(other) {
      ...
      let t7, t7$;
      if (!dart.equals(dart.runtimeType(other), this[$runtimeType])) return false;
      return image_provider.FileImage.is(other) && (t7 = other.file, t7 == null ? null : t7.path) == (t7$ = this.file, t7$ == null ? null : t7$.path) && other.scale == this.scale;
    }
    get hashCode() {
      let t7;
    ...
    toString() {
      let t7;
      return dart.str(object.objectRuntimeType(this, "FileImage")) + "(\"" + dart.str((t7 = this.file, t7 == null ? null : t7.path)) + "\", scale: " + dart.str(this.scale) + ")";
    }
  };
  ...
  image_cache.ImageCache = class ImageCache extends core.Object {
    ...
    [_checkCacheSize]() {
      ...
      if (!(dart.notNull(this[_currentSizeBytes]) >= 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_cache.dart", 239, 12, "_currentSizeBytes >= 0");
      if (!(dart.notNull(this[_cache][$length]) <= dart.notNull(this.maximumSize))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_cache.dart", 240, 12, "_cache.length <= maximumSize");
      if (!(dart.notNull(this[_currentSizeBytes]) <= dart.notNull(this.maximumSizeBytes))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_cache.dart", 241, 12, "_currentSizeBytes <= maximumSizeBytes");
    }
  };
  ...
  const RRect_webOnlyUniformRadii = dart.privateName(ui, "RRect.webOnlyUniformRadii");
  ...
  shader_warm_up.DefaultShaderWarmUp = class DefaultShaderWarmUp extends shader_warm_up.ShaderWarmUp {
    ...
    warmUpOnCanvas(canvas) {
      return async.async(dart.void, (function* warmUpOnCanvas() {
        ...
        let circlePath = (t13$ = ui.Path.new(), t13$.addOval(new ui.Rect.fromCircle({center: C42 || CT.C42, radius: 20.0})), t13$);
        let path = ui.Path.new();
        ...
        let paints = JSArrayOfPaint().of([(t13$0 = ui.Paint.new(), t13$0.isAntiAlias = true, t13$0.style = ui.PaintingStyle.fill, t13$0), (t13$1 = ui.Paint.new(), t13$1.isAntiAlias = false, t13$1.style = ui.PaintingStyle.fill, t13$1), (t13$2 = ui.Paint.new(), t13$2.isAntiAlias = true, t13$2.style = ui.PaintingStyle.stroke, t13$2.strokeWidth = 10.0, t13$2), (t13$3 = ui.Paint.new(), t13$3.isAntiAlias = true, t13$3.style = ui.PaintingStyle.stroke, t13$3.strokeWidth = 0.1, t13$3)]);
        ...
        let paragraph = (t13$5 = paragraphBuilder.build(), t13$5.layout(C43 || CT.C43), t13$5);
        canvas.drawParagraph(paragraph, C44 || CT.C44);
        for (let fraction of JSArrayOfdouble().of([0.0, 0.5])) {
          t13$6 = canvas;
          t13$6.save();
          t13$6.translate(fraction, fraction);
          t13$6.clipRRect(new ui.RRect.fromLTRBR(8.0, 8.0, 328.0, 248.0, C45 || CT.C45));
          t13$6.drawRect(C46 || CT.C46, ui.Paint.new());
          t13$6.restore();
          t13$6;
          canvas.translate(this.drawCallSpacing, 0.0);
        }
  ...
  decoration_image.paintImage = function paintImage(opts) {
    ...
    let paint = (t14 = ui.Paint.new(), t14.isAntiAlias = false, t14);
  ...
  box_shadow.BoxShadow = class BoxShadow extends ui.Shadow {
    ...
    toPaint() {
      let t14;
      let result = (t14 = ui.Paint.new(), t14.color = this.color, t14.maskFilter = new ui.MaskFilter.blur(ui.BlurStyle.normal, this.blurSigma), t14);
      if (!dart.test(dart.fn(() => {
  ...
  box_decoration.BoxDecoration = class BoxDecoration extends decoration.Decoration {
    ...
    getClipPath(rect, textDirection) {
      ...
      switch (this.shape) {
        ...
        case C10 || CT.C10:
        {
          if (this.borderRadius != null) clipPath = (t15$ = ui.Path.new(), t15$.addRRect(this.borderRadius.resolve(textDirection).toRRect(rect)), t15$);
          break;
        }
      }
      return clipPath;
  ...
  box_decoration._BoxDecorationPainter = class _BoxDecorationPainter extends decoration.BoxPainter {
    ...
    paint(canvas, offset, configuration) {
      ...
      t15 == null ? null : t15.paint(canvas, rect, {shape: this[_decoration$0].shape, borderRadius: border_radius.BorderRadius.as(this[_decoration$0].borderRadius), textDirection: configuration.textDirection});
    }
    toString() {
  ...
  box_border.BoxBorder = class BoxBorder extends borders$.ShapeBorder {
    ...
    static _paintUniformBorderWithRadius(canvas, rect, side, borderRadius) {
      ...
      let paint = (t15 = ui.Paint.new(), t15.color = side.color, t15);
  ...
  text_painter.TextPainter = class TextPainter extends core.Object {
    ...
    set text(value) {
      let t17, t17$;
      if (!(value == null || dart.test(value.debugAssertIsValid()))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 189, 12, "value == null || value.debugAssertIsValid()");
    ...
    set textAlign(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 206, 12, "value != null");
    ...
    set textScaleFactor(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 247, 12, "value != null");
    ...
    set ellipsis(value) {
      if (!(value == null || value[$isNotEmpty])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 274, 12, "value == null || value.isNotEmpty");
    ...
    set maxLines(value) {
      if (!(value == null || dart.notNull(value) > 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 302, 12, "value == null || value > 0");
    ...
    set textWidthBasis(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 336, 12, "value != null");
    ...
    setPlaceholderDimensions(value) {
      ...
      }, VoidToint())() == value[$length])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 377, 12, "() {\r\n      int placeholderCount = 0;\r\n      text.visitChildren((InlineSpan span) {\r\n        if (span is PlaceholderSpan) {\r\n          placeholderCount += 1;\r\n        }\r\n        return true;\r\n      });\r\n      return placeholderCount;\r\n    }() == value.length");
      this[_placeholderDimensions] = value;
      this.markNeedsLayout();
    }
    [_createParagraphStyle](defaultTextDirection = null) {
      let t18, t17, t18$, t17$;
      if (!(this.textAlign != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 395, 12, "textAlign != null");
      if (!(this.textDirection != null || defaultTextDirection != null)) dart.assertFailed("TextPainter.textDirection must be set to a non-null value before using the TextPainter.", "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 396, 12, "textDirection != null || defaultTextDirection != null");
    ...
    get preferredLineHeight() {
      ...
      if (this[_layoutTemplate] == null) {
        ...
        builder.addText(" ");
        this[_layoutTemplate] = (t17$ = builder.build(), t17$.layout(C97 || CT.C97), t17$);
      }
    ...
    get minIntrinsicWidth() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 456, 12, "!_needsLayout");
      return this[_applyFloatingPointHack](this[_paragraph].minIntrinsicWidth);
    }
    get maxIntrinsicWidth() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 464, 12, "!_needsLayout");
      return this[_applyFloatingPointHack](this[_paragraph].maxIntrinsicWidth);
    }
    get width() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 472, 12, "!_needsLayout");
    ...
    get height() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 482, 12, "!_needsLayout");
      return this[_applyFloatingPointHack](this[_paragraph].height);
    }
    get size() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 490, 12, "!_needsLayout");
      return new ui.Size.new(this.width, this.height);
    }
    computeDistanceToActualBaseline(baseline) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 499, 12, "!_needsLayout");
      if (!(baseline != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 500, 12, "baseline != null");
      switch (baseline) {
        case C98 || CT.C98:
        {
    ...
    get didExceedMaxLines() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 522, 12, "!_needsLayout");
    ...
    layout(opts) {
      ...
      if (!(this.text != null)) dart.assertFailed("TextPainter.text must be set to a non-null value before using the TextPainter.", "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 538, 12, "text != null");
      if (!(this.textDirection != null)) dart.assertFailed("TextPainter.textDirection must be set to a non-null value before using the TextPainter.", "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 539, 12, "textDirection != null");
    ...
    paint(canvas, offset) {
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 574, 12, "() {\r\n      if (_needsLayout) {\r\n        throw FlutterError(\r\n          'TextPainter.paint called when text geometry was not yet calculated.\\n'\r\n          'Please call layout() before paint() to position the text before painting it.'\r\n        );\r\n      }\r\n      return true;\r\n    }()");
    ...
    get [_emptyOffset]() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 707, 12, "!_needsLayout");
      if (!(this.textAlign != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 708, 12, "textAlign != null");
      switch (this.textAlign) {
        ...
        case C96 || CT.C96:
        {
          if (!(this.textDirection != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 718, 16, "textDirection != null");
        ...
        case C104 || CT.C104:
        {
          if (!(this.textDirection != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 727, 16, "textDirection != null");
          switch (this.textDirection) {
            case C18 || CT.C18:
            {
              return ui.Offset.zero;
    ...
    [_computeCaretMetrics](position, caretPrototype) {
      let t17, t17$;
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 769, 12, "!_needsLayout");
      if (dart.equals(position, this[_previousCaretPosition]) && dart.equals(caretPrototype, this[_previousCaretPrototype])) return;
      let offset = position.offset;
      if (!(position.affinity != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 773, 12, "position.affinity != null");
      let rect = null;
    ...
    getBoxesForSelection(selection) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 801, 12, "!_needsLayout");
      return this[_paragraph].getBoxesForRange(selection.start, selection.end);
    }
    getPositionForOffset(offset) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 807, 12, "!_needsLayout");
      return this[_paragraph].getPositionForOffset(offset);
    }
    getWordBoundary(position) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 819, 12, "!_needsLayout");
      return this[_paragraph].getWordBoundary(position);
    }
    getLineBoundary(position) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 827, 12, "!_needsLayout");
      return this[_paragraph].getLineBoundary(position);
    }
    computeLineMetrics() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 847, 12, "!_needsLayout");
  ...
  (text_painter.TextPainter.new = function(opts) {
    ...
    this[_previousCaretPosition] = null;
    this[_previousCaretPrototype] = null;
    if (!(text == null || dart.test(text.debugAssertIsValid()))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 145, 15, "text == null || text.debugAssertIsValid()");
    if (!(textAlign != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 146, 15, "textAlign != null");
    if (!(textScaleFactor != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 147, 15, "textScaleFactor != null");
    if (!(maxLines == null || dart.notNull(maxLines) > 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 148, 15, "maxLines == null || maxLines > 0");
    if (!(textWidthBasis != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 149, 15, "textWidthBasis != null");
    this[_text] = text;
  ...
  (placeholder_span.PlaceholderSpan.new = function(opts) {
    let alignment = opts && 'alignment' in opts ? opts.alignment : C107 || CT.C107;
    let baseline = opts && 'baseline' in opts ? opts.baseline : null;
    let style = opts && 'style' in opts ? opts.style : null;
  ...
  flutter_logo.FlutterLogoStyle.markOnly = C117 || CT.C117;
  flutter_logo.FlutterLogoStyle.horizontal = C118 || CT.C118;
  flutter_logo.FlutterLogoStyle.stacked = C119 || CT.C119;
  flutter_logo.FlutterLogoStyle.values = C120 || CT.C120;
  let C121;
  let C122;
  let C123;
  ...
  (flutter_logo.FlutterLogoDecoration.new = function(opts) {
    let lightColor = opts && 'lightColor' in opts ? opts.lightColor : C121 || CT.C121;
    let darkColor = opts && 'darkColor' in opts ? opts.darkColor : C122 || CT.C122;
    let textColor = opts && 'textColor' in opts ? opts.textColor : C123 || CT.C123;
    let style = opts && 'style' in opts ? opts.style : C117 || CT.C117;
  ...
  flutter_logo._FlutterLogoPainter = class _FlutterLogoPainter extends decoration.BoxPainter {
    [_prepareText]() {
      ...
      let textSize = this[_textPainter].getBoxesForSelection(C124 || CT.C124)[$single];
    ...
    [_paintLogo](canvas, rect) {
      ...
      let lightPaint = (t17 = ui.Paint.new(), t17.color = this[_config$].lightColor.withOpacity(0.8), t17);
      let mediumPaint = (t17$ = ui.Paint.new(), t17$.color = this[_config$].lightColor, t17$);
      let darkPaint = (t17$0 = ui.Paint.new(), t17$0.color = this[_config$].darkColor, t17$0);
      let triangleGradient = ui.Gradient.linear(C125 || CT.C125, C126 || CT.C126, JSArrayOfColor().of([C127 || CT.C127, C128 || CT.C128, C129 || CT.C129, C130 || CT.C130, C131 || CT.C131, C132 || CT.C132, C133 || CT.C133, C134 || CT.C134, C135 || CT.C135]), JSArrayOfdouble().of([0.269, 0.4093, 0.4972, 0.5708, 0.6364, 0.6968, 0.7533, 0.8058, 0.8219]));
      let trianglePaint = (t17$1 = ui.Paint.new(), t17$1.shader = triangleGradient, t17$1.blendMode = ui.BlendMode.multiply, t17$1);
      let rectangleGradient = ui.Gradient.linear(C136 || CT.C136, C137 || CT.C137, JSArrayOfColor().of([C138 || CT.C138, C139 || CT.C139, C140 || CT.C140, C141 || CT.C141, C142 || CT.C142, C143 || CT.C143, C144 || CT.C144, C145 || CT.C145, C146 || CT.C146]), JSArrayOfdouble().of([0.4588, 0.5509, 0.6087, 0.657, 0.7001, 0.7397, 0.7768, 0.8113, 0.8219]));
      let rectanglePaint = (t17$2 = ui.Paint.new(), t17$2.shader = rectangleGradient, t17$2.blendMode = ui.BlendMode.multiply, t17$2);
      ...
      canvas.save();
      canvas.transform(_native_typed_data.NativeFloat64List.fromList(C147 || CT.C147));
      canvas.drawRect(C148 || CT.C148, mediumPaint);
      canvas.restore();
    ...
    paint(canvas, offset, configuration) {
      ...
      if (dart.notNull(this[_config$][_opacity]) < 1.0) {
        canvas.saveLayer(offset['&'](canvasSize), (t17 = ui.Paint.new(), t17.colorFilter = new _engine.EngineColorFilter.mode((C152 || CT.C152).withOpacity(this[_config$][_opacity]), ui.BlendMode.modulate), t17));
      }
      if (this[_config$][_position] !== 0.0) {
        if (dart.notNull(this[_config$][_position]) > 0.0) {
          ...
          this[_textPainter].paint(canvas, ui.Offset.zero);
          if (dart.notNull(this[_config$][_position]) > -1.0) {
            canvas.drawRect(this[_textBoundingRect].inflate(dart.notNull(this[_textBoundingRect].width) * 0.5), (t17$0 = ui.Paint.new(), t17$0.blendMode = ui.BlendMode.modulate, t17$0.shader = ui.Gradient.linear(new ui.Offset.new(dart.notNull(this[_textBoundingRect].width) * -0.5, 0.0), new ui.Offset.new(dart.notNull(this[_textBoundingRect].width) * 1.5, 0.0), JSArrayOfColor().of([C152 || CT.C152, C152 || CT.C152, C153 || CT.C153, C153 || CT.C153]), JSArrayOfdouble().of([0.0, math.max(core.double, 0.0, this[_config$][_position][$abs]() - 0.1), math.min(core.double, this[_config$][_position][$abs]() + 0.1, 1.0), 1.0])), t17$0));
          }
          canvas.restore();
        }
      }
      ...
      switch (this.side.style) {
        ...
        case C13 || CT.C13:
        {
          ...
          if (width === 0.0) {
            ...
            let inner = outer.deflate(width);
            let paint = (t17 = ui.Paint.new(), t17.color = this.side.color, t17);
            canvas.drawDRRect(outer, inner, paint);
          }
        }
      }
  ...
  matrix_utils.debugDescribeTransform = function debugDescribeTransform(transform) {
    if (transform == null) return C154 || CT.C154;
  ...
  image_resolution.AssetImage = class AssetImage extends image_provider.AssetBundleImageProvider {
    ...
    obtainKey(configuration) {
      ...
      let completer = null;
      let result = null;
      chosenBundle.loadStructuredData(MapOfString$ListOfString(), "AssetManifest.json", C155 || CT.C155).then(dart.void, dart.fn(manifest => {
