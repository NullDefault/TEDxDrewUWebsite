define(['dart_sdk', 'packages/flutter/src/animation/animation'], function(dart_sdk, packages__flutter__src__animation__animation) {
  ...
  const name$ = dart.privateName(multi_track_tween, "Track.name");
  const items = dart.privateName(multi_track_tween, "Track.items");
  ...
  const tween$ = dart.privateName(multi_track_tween, "_TrackItem.tween");
  ...
  }, '{"version":3,"sourceRoot":"","sources":["multi_track_tween.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;0BA2CuC;AAMjC,MALF,AAAO,MAAD,WAAS,QAAC;AACR,4BAAgB,AAAM,AACvB,AACA,KAFsB,uBAClB,QAAC,QAAS,AAAK,AAAS,IAAV,uDACX,SAAC,KAAK,SAAa,aAAJ,GAAG,iBAAG,IAAI;AACU,QAA/C,qBAAe,mBAAI,oBAAc,aAAa;;IAElD;0BAEqC;AAsBjC,MArBF,AAAO,MAAD,WAAS,QAAC;AACR,4BAAgB,AAAM,AACvB,AACA,KAFsB,uBAClB,QAAC,QAAS,AAAK,AAAS,IAAV,uDACX,SAAC,KAAK,SAAa,aAAJ,GAAG,iBAAG,IAAI;AAE/B,4BAAgB,AAAM,AACvB,AAGA,KAJsB,+CAClB,QAAC,QAAS,iDACJ,AAAK,IAAD,gBAC0B,aAA7B,AAAK,AAAS,IAAV,yCAA2B;AAG/C,YAAkB,aAAd,aAAa,iBAAG;AAGyC,UAF3D,AAAc,aAAD,OAAK,iDACP,4BAAc,eACkB,CAAjB,aAAb,mCAAe,aAAa,kBAAI;;AAGzC,uBAAW,qCAAc,aAAa;AAG0B,QADtE,AAAc,4BAAC,AAAM,KAAD,OAChB,6CAAkB,QAAQ,WAAyB,aAAd,aAAa,iBAAG;;IAE7D;;AAqBE,YAAO,sCAAuB;IAChC;cAGsC;AACT,mBAAS;AAIlC,MAHF,AAAe,+BAAQ,SAAC,MAAM;AACf,qBAAS,sBAAI,KAAG,sBAAI,CAAC,EAAoB,aAAlB,AAAU,SAAD,YAAW;AACR,QAAhD,AAAM,MAAA,QAAC,IAAI,EAAI,AAAU,AAAM,SAAP,iBAAiB,MAAM;;AAEjD,YAAO,OAAM;IACf;;oDAzE4B;IAHtB,uBAAiB;IACnB,qBAAe;UAGN,AAAe,MAAT,IAAI,QAAsB,aAAd,AAAO,MAAD,aAAU,sBACrC;UACG,AAAO,AAA0C,AAAO,MAAlD,SAAO,QAAC,SAAU,AAAM,AAAM,AAAO,KAAd,oBAAiB,gCAAa,sBAC9D;AAJV;AAK6B,IAA3B,0BAAoB,MAAM;AACC,IAA3B,0BAAoB,MAAM;EAC5B;;;;;;;;;;;;;;;;;;;;;;;;MAuEa;;;;;;MACU;;;;;;UAWD;+BAAwB;YAAc;AACN,QAApD,AAAM,iBAAI,qCAAW,QAAQ,EAAE,KAAK,UAAS,KAAK;AAClD,cAAO;MACT;;0BAZW;MAFY,cAAQ;MAEpB;YAAe,AAAK,IAAD,IAAI,yBAAM;;IAA+B;;;;;;;;;;;;;;;;;;;;;;MAiBzD;;;;;;;+BAEE,UAAwB;UAAe;MAFzC;MAEE;YACH,AAAS,QAAD,IAAI,yBAAM;YAClB,AAAO,MAAD,IAAI,yBAAM;AAC3B,UAAI,KAAK,IAAI;AACmC,QAA9C,aAAQ,AAAO,MAAD,OAAO,iCAAkB,KAAK;;AAE9B,QAAd,aAAQ,MAAM;;IAElB;;;;;;;;;;;;;;;;;UAOiB;UAAY;MAAZ;MAAY;;IAAS","file":"multi_track_tween.ddc.js"}');
  // Exports:
  return {
